...
execute if score #displayseconds spl.game matches ..9 run bossbar set spl:timer name [{"score": {"name": "#displayminutes","objective": "spl.game"}},":0",{"score": {"name": "#displayseconds","objective": "spl.game"}}," until spl begins"]
execute if score #displayseconds spl.game matches 10.. run bossbar set spl:timer name [{"score": {"name": "#displayminutes","objective": "spl.game"}},":",{"score": {"name": "#displayseconds","objective": "spl.game"}}," until spl begins"]
