...
execute as @a[scores={GLOBAL.player_left=1..},tag=!admin] run function qq:states/pregame/join
execute as @a[scores={GLOBAL.time_alive=0},tag=!admin] run function qq:states/pregame/while_dead
execute as @a[scores={GLOBAL.time_alive=1},tag=!admin] run function qq:states/pregame/respawn
