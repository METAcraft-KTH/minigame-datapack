...
execute if score mode qq.config matches 0 run item replace entity @s hotbar.1 with stone_sword
...
execute if score mode qq.config matches 1 run give @s shield

# Combined
execute if score mode qq.config matches 2 run function qq:give/raycast_crossbow
execute if score mode qq.config matches 2 run give @s iron_sword
