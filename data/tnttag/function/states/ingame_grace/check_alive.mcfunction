...
title @a[tag=ttag.died,team=tnttag.tagged,tag=!admin] subtitle "You were holding TNT"
title @a[tag=ttag.died,team=!tnttag.tagged,tag=!admin] subtitle "You stood too close to an explosion"
