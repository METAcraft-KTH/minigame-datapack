advancement revoke @s only tnttag:punched
...
execute on attacker if entity @s[team=!tnttag.tagged] run return 0
# dont run if victim has tnt
execute if entity @s[team=tnttag.tagged] run return 0

## transfer tnt
execute on attacker run team leave @s
team join tnttag.tagged @s
