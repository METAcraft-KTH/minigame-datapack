...
execute if score #displayseconds hh.game matches ..9 run bossbar set hh:timer name ["Half Heart Race ends in ",{"score": {"name": "#displayminutes","objective": "hh.game"}},":0",{"score": {"name": "#displayseconds","objective": "hh.game"}}]
execute if score #displayseconds hh.game matches 10.. run bossbar set hh:timer name ["Half Heart Race ends in ",{"score": {"name": "#displayminutes","objective": "hh.game"}},":",{"score": {"name": "#displayseconds","objective": "hh.game"}}]
