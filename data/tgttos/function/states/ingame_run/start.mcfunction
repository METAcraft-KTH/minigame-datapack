...
execute at @n[tag=tgttos.tp.arena] run fill ~30 ~-1 ~30 ~-30 ~3 ~-30 structure_void replace tinted_glass
execute at @n[tag=tgttos.tp.arena] run fill ~30 ~4 ~30 ~-30 ~6 ~-30 structure_void replace tinted_glass
execute at @n[tag=tgttos.tp.arena] run fill ~30 ~7 ~30 ~-30 ~9 ~-30 structure_void replace tinted_glass
execute at @n[tag=tgttos.tp.arena] run fill ~30 ~9 ~30 ~-30 ~12 ~-30 structure_void replace tinted_glass