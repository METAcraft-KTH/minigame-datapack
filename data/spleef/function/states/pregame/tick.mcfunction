...
execute if score #displayseconds spleef.game matches ..9 run bossbar set spleef:timer name ["Intro ",{"score": {"name": "#displayminutes","objective": "spleef.game"}},":0",{"score": {"name": "#displayseconds","objective": "spleef.game"}}]
execute if score #displayseconds spleef.game matches 10.. run bossbar set spleef:timer name ["Intro ",{"score": {"name": "#displayminutes","objective": "spleef.game"}},":",{"score": {"name": "#displayseconds","objective": "spleef.game"}}]
