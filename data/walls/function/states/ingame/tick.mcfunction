...
execute if score ?state WALLS.game = state.r1.deathmatch WALLS.config if score ?timer WALLS.game >= time..r1.deathmatch WALLS.config run function walls:states/ingame/start.r2
