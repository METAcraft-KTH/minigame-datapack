...
execute unless entity @s[tag=!admin,tag=!WALLS.in_r1] if function walls:states/ingame/is_r1 unless function walls:states/ingame/is_deathmatch run function walls:states/ingame/join.new_player
execute unless entity @s[tag=!admin,tag=!WALLS.in_r2] if function walls:states/ingame/is_r2 unless function walls:states/ingame/is_deathmatch run function walls:states/ingame/join.new_player

execute unless entity @s[tag=!admin,tag=WALLS.in_r1] if function walls:states/ingame/is_deathmatch run say 1
