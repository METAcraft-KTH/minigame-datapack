...
execute if score #red_playercount WALLS.tmp matches 0 if score #blue_playercount WALLS.tmp matches 0 if score #green_playercount WALLS.tmp matches 0 if score #yellow_playercount WALLS.tmp matches 0 run function walls:states/ingame/gameover/draw
