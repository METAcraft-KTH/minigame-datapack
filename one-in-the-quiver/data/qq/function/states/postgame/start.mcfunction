...
# new state, reset per-player in-state marker
scoreboard players reset * qq.in_state
scoreboard players set @a[tag=!admin] qq.in_state 1
...
# respawn everyone
scoreboard players set @a[gamemode=spectator,tag=!admin] qq.time_alive 60
