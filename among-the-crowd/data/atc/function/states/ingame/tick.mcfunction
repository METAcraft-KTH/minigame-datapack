...
execute if score #displayseconds atc.game matches ..9 run bossbar set atc:timer name ["Among the Crowd ends in ",{"score": {"name": "#displayminutes","objective": "atc.game"}},":0",{"score": {"name": "#displayseconds","objective": "atc.game"}}]
execute if score #displayseconds atc.game matches 10.. run bossbar set atc:timer name ["Among the Crowd ends in ",{"score": {"name": "#displayminutes","objective": "atc.game"}},":",{"score": {"name": "#displayseconds","objective": "atc.game"}}]
