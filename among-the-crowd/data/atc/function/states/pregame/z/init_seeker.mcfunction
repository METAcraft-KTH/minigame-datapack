...
title @s title {"text": "You are the first seeker!"}
title @s subtitle {"text": "You will become a hider when you get your first kill!"}
tellraw @s {"text": "You are the first seeker!"}
tellraw @s {"text": "You will become a hider when you get your first kill!"}
