...
# Executor:  Server
#
# IT lost both wardens.
# ============================================================

title @a times 5 70 20
title @a title [{text:"Data",color:"#e83d84",bold:true},{text:" WINS",color:"white",bold:true}]
title @a subtitle {text:"Both IT wardens are down",color:"gray"}
tellraw @a [{text:"Data",color:"#e83d84",bold:true},{text:" wins — both IT wardens are down!",color:"white"}]
