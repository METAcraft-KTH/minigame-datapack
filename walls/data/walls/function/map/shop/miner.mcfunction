...
data modify storage walls:shop offers append value {buy:{id:"minecraft:prismarine_crystals",count:1},sell:{id:"minecraft:experience_bottle",count:16},maxUses:9999,uses:0,rewardExp:false,xp:0,priceMultiplier:0.0f}
