...
execute if score ?round.number exact.game matches 1 run gamerule block_drops true
...
execute if score ?round.number exact.game matches 2 run gamerule block_drops false
