...
execute if score #displayseconds exact.game matches ..9 run bossbar set exact:timer name [{"score": {"name": "#displayminutes","objective": "exact.game"}},":0",{"score": {"name": "#displayseconds","objective": "exact.game"}}," until MINECRAFT HEXATHLON 4 begins"]
execute if score #displayseconds exact.game matches 10.. run bossbar set exact:timer name [{"score": {"name": "#displayminutes","objective": "exact.game"}},":",{"score": {"name": "#displayseconds","objective": "exact.game"}}," until MINECRAFT HEXATHLON 4 begins"]
