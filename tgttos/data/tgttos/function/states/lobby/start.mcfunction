...
# initialize timer
execute store result bossbar tgttos:timer max run scoreboard players get time.lobby tgttos.config
...
execute as @a[tag=!admin] run function tgttos:states/lobby/reset_player
