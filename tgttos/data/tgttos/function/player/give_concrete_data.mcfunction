# ============================================================
# tgttos:player/give_concrete_data
# Called by: tgttos:player/setup, tgttos:util/second
# Executor:  A Data player
#
...
give @s minecraft:pink_concrete[minecraft:can_place_on={},minecraft:tooltip_display={hidden_components:["can_place_on"]}] 64
