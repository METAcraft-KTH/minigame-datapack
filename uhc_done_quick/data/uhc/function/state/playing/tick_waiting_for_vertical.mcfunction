...
scoreboard players operation #ticks main.temp = ?time_until_vertical uhc.time
...
#   set bossbar name
bossbar set uhc:bossbar name [{score:{name:"#min",objective:"uhc.temp"},color:"green"},":",{score:{name:"#sec_tens",objective:"uhc.temp"}},{score:{name:"#sec_ones",objective:"uhc.temp"}},{text:" until vertical world border rises",color:"white"}]
