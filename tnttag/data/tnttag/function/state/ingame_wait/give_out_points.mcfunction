...
execute as @a[tag=!tnttag.died] run function score:add_points {points:25}
execute as @a[tag=!tnttag.died,team=tnttag.has_diamond] run tellraw @a [{selector:"@s",color:"aqua"}," survived with a diamond!"]
